...
var functionSass = function functionSass(done) {
...
var functionService = function functionService(done) {
	...
	gulp.watch("scss/*.scss", gulp.series(functionSass));
...
gulp.task('run_service', gulp.series(functionSass, functionService));
